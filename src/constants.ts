...
export const MEDIA_ICONS_PATH = path.join(
    ...
    "media",
    "icons");
export const MEDIA_ICONS_TAB_PATH = path.join(MEDIA_ICONS_PATH, NOTES_TREE_VIEW_ICON);
export const NOTE_ITEM_ICON = vscode.Uri.file(MEDIA_ICONS_TAB_PATH);
export const NOTE_ITEM_TOOLTIP = (fileName: string, note: string) => `${fileName}\n=====\n${note}`;
...
export const ADD_NOTE_COMMAND_ERROR_MESSAGE = "Cannot add note. No active text editor found.";
export const DELETE_CURRENT_NOTE_COMMAND_ERROR_MESSAGE = "Cannot delete note. No active text editor found.";
export const VIEW_EDIT_CURRENT_NOTE_COMMAND_ERROR_MESSAGE = "Cannot view/edit note. No active text editor found.";

export const ADD_NOTE_COMMAND_ID = "extension.addNote";
export const VIEW_EDIT_CURRENT_NOTE_COMMAND_ID = "extension.viewEditCurrentNote";
...
export const VIEW_EDIT_NOTE_INPUT_DEFAULT_PLACEHOLDER = "Enter a note for this tab";
export const VIEW_EDIT_NOTE_ITEM_INPUT_PLACEHOLDER = (noteItemName: string) => `Edit note for ${noteItemName}`;
export const VIEW_EDIT_NOTE_ITEM_INPUT_PROMPT = (noteItemName: string) => `View/Edit note for ${noteItemName}`;
export const VIEW_EDIT_NOTE_INPUT_DEFAULT_PROMPT = "View/Edit note for this tab";
